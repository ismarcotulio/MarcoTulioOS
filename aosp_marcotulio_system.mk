...
#
$(call inherit-product,$(LOCAL_PATH)/phone/device_vendor.mk)
...
PRODUCT_NAME := aosp_cf_marcotulio_system_x86_phone
PRODUCT_DEVICE := vsoc_x86
PRODUCT_MANUFACTURER := Marco Tulio Ruiz
PRODUCT_MODEL := Cuttlefish Marco Tulio's System  x86 phone
